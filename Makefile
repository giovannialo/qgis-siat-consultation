...
SOURCES = \
	__init__.py \
	siat_consultation.py siat_consultation_dialog.py

PLUGINNAME = siat_consultation

PY_FILES = \
	__init__.py \
	siat_consultation.py siat_consultation_dialog.py

UI_FILES = siat_consultation_dialog_base.ui
...
QGISDIR=C:\Users\giovannioliveira\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
